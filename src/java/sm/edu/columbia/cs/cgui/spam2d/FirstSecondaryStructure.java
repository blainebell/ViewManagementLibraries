...
class FirstSecondaryStructure extends SecondaryStructure implements Cloneable {
    ...
    static {
	try {
	    nodeClass=Class.forName("edu.columbia.cs.cgui.spam2d.Rectangle2d");
	    minyMeth=nodeClass.getDeclaredMethod("getMinY",null); 
	    maxyMeth=nodeClass.getDeclaredMethod("getMaxY",null);
	    ss = Class.forName("edu.columbia.cs.cgui.spam2d.SecondSecondaryStructure");
	...
	secondaryIntervalTree.addRectangle((Rectangle2d)ob);
	return (true);
    }
	...
	return (secondaryIntervalTree.deleteRectangle((Rectangle2d)ob));
    }
