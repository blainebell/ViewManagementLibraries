...
class SecondYZSecondaryStructure3d extends SecondaryStructure implements Cloneable {
    private static final long serialVersionUID=2385712039912385923L;
    private RectangleTree3d rt[] = new RectangleTree3d[4];
    
    SecondYZSecondaryStructure3d() throws NoSuchMethodException, ClassNotFoundException {
	rt[0] = new RectangleTree3d(new MinYComparator3d());
	rt[1] = new RectangleTree3d(new MaxYComparator3d());
	rt[2] = new RectangleTree3d(new MinZComparator3d());
	rt[3] = new RectangleTree3d(new MaxZComparator3d());
    }
    protected Object clone(){
	SecondYZSecondaryStructure3d clone = null;
	clone = (SecondYZSecondaryStructure3d) super.clone();
	for (int i=0; i<4; i++){
