...
class Rectangle2d implements Cloneable,Serializable {
    ...
    Rectangle2d(double mx, double my, double xx, double xy){
    ...
    void setRect(double mx, double my, double xx, double xy){
	minx = (double)mx; miny = (double)my; maxx = (double)xx; maxy = (double)xy;
    }
    Rectangle2d(){
    ...
    double getX(){ return minx; }
    double getY(){ return miny; }
    double getWidth(){ return maxx-minx; }
    double getHeight(){ return maxy-miny; }
    double getCenterX(){ return getX() + (getWidth()/2.); }
    double getCenterY(){ return getY() + (getHeight()/2.); }
    double getMinX(){ return minx; }
    double getMinY(){ return miny; }
    double getMaxX(){ return maxx; }
    double getMaxY(){ return maxy; }
    void setMinX(double v){ minx = (double)v; }
    void setMinY(double v){ miny = (double)v; }
    void setMaxX(double v){ maxx = (double)v; }
    void setMaxY(double v){ maxy = (double)v; }
}
