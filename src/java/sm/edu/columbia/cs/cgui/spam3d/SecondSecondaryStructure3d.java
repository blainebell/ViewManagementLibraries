...
class SecondSecondaryStructure3d extends SecondaryStructure implements Cloneable {
    private static final long serialVersionUID=1237409029816253519L;
	...
	try {
	    ...
	    ss = Class.forName("edu.columbia.cs.cgui.spam3d.ThirdSecondaryStructure3d");
	} catch (ClassNotFoundException cnf){
	    cnf.printStackTrace();
	} catch (NoSuchMethodException nsm){
	    nsm.printStackTrace();
	}
	iD = new IntervalDimension(3,minzMeth,maxzMeth);
    }
    //    private TreeSet minTree,maxTree;
    SecondSecondaryStructure3d() throws NoSuchMethodException, ClassNotFoundException {
	secondaryIntervalTree = new IntervalTree3d(nodeClass,minzMeth,maxzMeth,ss,iD);
    }
    protected Object clone(){
	SecondSecondaryStructure3d clone = null;
	clone = (SecondSecondaryStructure3d) super.clone();
	...
	//	System.out.println("SecondSecondaryStructure3d.windowQuery\t r=" + r + "\tnC=");
	//	nC.print(System.out);
	...
	System.out.println("SecondSecondaryStructure3d.print()");
