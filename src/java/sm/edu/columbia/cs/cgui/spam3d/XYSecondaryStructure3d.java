...
class XYSecondaryStructure3d extends SecondaryStructure implements Cloneable {
	...
	try {
	    ...
	    ss = Class.forName("edu.columbia.cs.cgui.spam3d.SecondXYSecondaryStructure3d");
    ...
    XYSecondaryStructure3d() throws NoSuchMethodException, ClassNotFoundException {
	secondaryIntervalTree = new IntervalTree3d(nodeClass,minyMeth,maxyMeth,ss,iD);
    }
    protected Object clone(){
	XYSecondaryStructure3d clone = null;
	clone = (XYSecondaryStructure3d) super.clone();
	...
	//	System.out.println("XYSecondaryStructure3d.windowQuery\t r=" + r + "\tnC=");
	//	nC.print(System.out);
	...
	System.out.println("XYSecondaryStructure3d.print()");
