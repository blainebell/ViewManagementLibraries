...
public class SpaceManagerTest3d extends JApplet {
    static SpaceManagerPanel3d spacemanagerpanel;
    // These are just so you don't have to compile individual classes
    static FirstSecondaryStructure3d fss;
    static SecondSecondaryStructure3d sss;
    static ThirdSecondaryStructure3d tss;
    static XSecondaryStructure3d xss;
    static YSecondaryStructure3d yss;
    static ZSecondaryStructure3d zss;
    ...
    JMenuItem printrectanglesitem,addrectanglesitem,printObjectTreeitem, printSpaceTreeitem,testcloneitem,loaditem,saveitem,newitem;
...
;
  ...
  public void createPanel(boolean applet){
    spacemanagerpanel = new SpaceManagerPanel3d(defaultlistmodel,jlist);

    spacemanagerpanel.setPreferredSize(new Dimension(1000,500));
    ...
    debugmenu.add(debugitem = new JCheckBoxMenuItem("Debug Data Structures",true));
    ...
    addrectitem.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent e){
	spacemanagerpanel.setMode(SpaceManagerPanel3d.ADDING);
    ...
    deleterectitem.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent e){
	spacemanagerpanel.setMode(SpaceManagerPanel3d.DELETING);
    ...
    moverectitem.addActionListener(new ActionListener() {
	    public void actionPerformed(ActionEvent e){
		spacemanagerpanel.setMode(SpaceManagerPanel3d.MOVING);
		addrectitem.setState(false);
		deleterectitem.setState(false);
    ...
    movefastrectitem.addActionListener(new ActionListener() {
	    public void actionPerformed(ActionEvent e){
		spacemanagerpanel.setMode(SpaceManagerPanel3d.MOVINGFAST);
		addrectitem.setState(false);
		deleterectitem.setState(false);
		moverectitem.setState(false);
  ...
  public SpaceManagerTest3d() {
      //    System.out.println("SpaceManagerTest3d()");
  }
  public SpaceManagerTest3d(String args[]) {
      //    System.out.println("SpaceManagerTest3d(String args[])");
  }
  static SpaceManagerTest3d smt;
  static JFrame frame;
  ...
  public static void main(String[] args) {
      //    System.out.println("SpaceManagerTest3d.main");
    ...
    smt = new SpaceManagerTest3d(args);
  ...
  //    List jlist = new List();
    ...
    frame.setContentPane(jpanel); //smt.spacemanagerpanel); //smt = new SpaceManagerTest3d(args));
